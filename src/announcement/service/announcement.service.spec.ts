...
describe('AnnouncementService', () => {
    ...
    describe('getForMember', () => {
        ...
        it('should return paginated results', async () => {
            ...
            const result = await service.getForMember('worker-1', MemberRoleEnum.WORKER, null, 1, 10);
    ...
    describe('delete', () => {
        it('should throw NotFoundException if announcement not found', async () => {
            ...
            await expect(service.delete('nonexistent-id', 'admin-1')).rejects.toThrow(NotFoundException);
        });
        ...
        it('should call findOne with correct id and relations', async () => {
            ...
            await expect(service.delete('ann-1', 'admin-1')).rejects.toThrow(NotFoundException);
