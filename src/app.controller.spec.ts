...
const mockConfigService = {get: jest.fn().mockImplementation((key: string) => CONFIG_DEFAULTS[key])};
...
describe('AppController', () => {
    ...
    describe('root', () => {
        it('should render the welcome page as HTML', () => {
            ...
            expect(mockRes.end).toHaveBeenCalledWith(expect.stringContaining('Discovery Hub'));
        });
    });
});
