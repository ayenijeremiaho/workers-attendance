...
export class Asset extends BaseEntity {
    ...
    @Column({type: 'decimal', precision: 15, scale: 2, nullable: true, name: 'purchase_value'})
    ...
    @Column({type: 'timestamptz', nullable: true, name: 'warranty_notified_30_days_at'})
    warrantyNotified30DaysAt: Date | null;

    @Column({type: 'timestamptz', nullable: true, name: 'warranty_notified_14_days_at'})
    warrantyNotified14DaysAt: Date | null;

    @Column({type: 'timestamptz', nullable: true, name: 'warranty_notified_7_days_at'})
