...
export class ChildrenChurchController {
  ...
  async searchChildren(
    ...
    return this.childrenChurchService.searchChildren(req.user, name, +page, +limit, classGroupId);
  }
  ...
  async getChildCheckInHistory(
    ...
    return this.childrenChurchService.getChildCheckInHistory(req.user, id, +page, +limit);
  }
  ...
  async getChildGuardians(@Request() req: any, @Param('id', ParseUUIDPipe) childId: string) {
  ...
  @Roles(MemberRoleEnum.ADMIN, MemberRoleEnum.WORKER)
  @Delete('guardians/:id')
  async removeGuardian(@Request() req: any, @Param('id', ParseUUIDPipe) id: string) {
  ...
  @Roles(MemberRoleEnum.ADMIN, MemberRoleEnum.WORKER)
  @Get('checkin/active')
  async getActiveCheckIns(@Request() req: any, @Query('classGroupId') classGroupId?: string) {
