...
@Module({
    ...
    controllers: [EventController, EventConfigController, EventReminderController],
    providers: [EventService, EventConfigService, DefaultEventConfigSeed, EventReminderService],
