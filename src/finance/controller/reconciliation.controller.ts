import {Body, Controller, Get, Param, ParseIntPipe, ParseUUIDPipe, Patch, Post, Query, UploadedFile, UseGuards, UseInterceptors} from '@nestjs/common';
...
export class ReconciliationController {
    ...
    @RequiresPermission(AdminPermission.FINANCE_RECONCILE)
    @Get('jobs/:id/rows')
    findRows(@Param('id', ParseUUIDPipe) id: string, @Query() query: ReconciliationRowQueryDto) {
    ...
    bulkConfirm(@Param('id', ParseUUIDPipe) id: string, @Body() dto: BulkConfirmReconciliationDto, @CurrentAdmin() admin: Admin) {
    ...
    postConfirmedRows(@Param('id', ParseUUIDPipe) id: string, @Body() dto: PostConfirmedRowsDto, @CurrentAdmin() admin: Admin) {
