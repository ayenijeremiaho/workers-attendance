...
import {PostEventProcessor, FOLLOW_UP_QUEUE} from './processor/post-event.processor';
...
@Module({
    imports: [
        ConfigModule,
        TypeOrmModule.forFeature([FirstTimer, FollowUpTask, FollowUpNote, WorkerProfile, Event, Attendance, Admin, AdminRole]),
