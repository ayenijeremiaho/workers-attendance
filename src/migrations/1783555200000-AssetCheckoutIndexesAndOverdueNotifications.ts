...
export class AssetCheckoutIndexesAndOverdueNotifications1783555200000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE IF EXISTS asset_checkout_notifications`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_asset_checkouts_expected_return`);
        await queryRunner.query(`DROP INDEX IF EXISTS idx_asset_checkouts_department`);
