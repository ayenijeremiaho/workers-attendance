...
export class CreateFinanceFunds1783641600000 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_finance_funds_type ON finance_funds(type)`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS idx_finance_funds_active ON finance_funds(is_active) WHERE is_active = true`);
    }
