...
export class NotesService {
  ...
  async delete(type: NoteTypeEnum, id: string): Promise<void> {
  ...
  private buildDetails(request: any): ChildNamingDetails | ChildDedicationDetails | MarriageDetails {
    switch (request.type) {
      ...
      case NoteTypeEnum.CHILD_DEDICATION:
        return { ...plainToInstance(ChildDedicationDetails, request), dedicationDate: new Date(request.dedicationDate) };
