...
const mockAdmin = {id: 'admin-1', member: {firstname: 'Ada', lastname: 'Admin'}};

const mockSlot = {id: 'slot-1', name: 'First Service', startTime: new Date('2026-06-15T08:00:00Z')};
...
describe('ServiceHeadcountService', () => {
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                {provide: getRepositoryToken(ServiceHeadcount), useValue: mockHeadcountRepo},
    ...
    describe('create', () => {
        it('creates and saves a headcount record with computed total', async () => {
            ...
            const dto = {serviceSlotId: 'slot-1', maleAdults: 100, femaleAdults: 120, teenagers: 30, children: 20, mobileChurch: 15};
            const result = await service.create(dto, mockAdmin as any);

            expect(mockServiceSlotRepo.findOne).toHaveBeenCalledWith({where: {id: 'slot-1'}});
        ...
        it('throws NotFoundException when service slot does not exist', async () => {
            ...
            await expect(service.create({serviceSlotId: 'bad-id'}, mockAdmin as any))
