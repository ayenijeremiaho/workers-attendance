...
const ssWorkerUser = { id: 'ss-worker-1', role: MemberRoleEnum.WORKER, requiresPasswordChange: false };
const otherWorkerUser = { id: 'other-worker-1', role: MemberRoleEnum.WORKER, requiresPasswordChange: false };
const memberUser = { id: 'member-1', role: MemberRoleEnum.MEMBER, requiresPasswordChange: false };
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        { provide: CacheService, useValue: { get: jest.fn(), set: jest.fn(), del: jest.fn(), key: jest.fn() } },
      ],
    }).compile();
