...
export class UtilityService {
    ...
    public static getPaginationResponseDto<I, O>(
        ...
        const data = response.data.map((value) =>
            plainToInstance(classConstructor, value, {excludeExtraneousValues: true}) as O,
        );
    ...
    public static async verifyHashedValue(value: string, hashedValue: string): Promise<boolean> {
